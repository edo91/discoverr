# Getting help with discoverr

Thanks for using discoverr. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/discoverr/issues) to make sure the 
